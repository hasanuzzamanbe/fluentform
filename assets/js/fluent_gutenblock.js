...
registerBlockType('fluentfom/guten-block', {
  ...
  edit: function edit(_ref) {
    ...
    var cssClass = "ff-preview-".concat(attributes.blockId); // Create the CSS class
...
function renderForm(formId, blockId) {
  ...
  var cssClass = ".ff-preview-".concat(blockId); // Create the CSS class

  var xhr = new XMLHttpRequest();
  var url = window.fluentform_block_vars.rest.url + '/block-preview';
  ...
  xhr.onreadystatechange = function () {
    if (xhr.readyState === 4 && xhr.status === 200) {
      ...
      var contentContainer = document.querySelector(cssClass);
